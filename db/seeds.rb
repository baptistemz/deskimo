...
# COMPANIES
mecatechnic = Company.create!(name: "mecatechnic", email: "contact@mecatechnic.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "3 rue Paul Langevin", city: "Tourcoing", postcode: "59599", description: "Spécialiste de pièces détachées VW. Bossez au milieu des belles bagnoles !", coffee: false, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/mecatechnic.jpg")))
deezer = Company.create!(name: "Deezer", email: "contact@deezer.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "108 rue Nationale", city: "Lille", postcode: "59000", description: "N°1 français en streaming musical. Bossez en écoutant la musique à donf !", coffee: true, wifi: true, printer: false, scanner: false, picture: File.open(Rails.root.join("db/seeds/images/deezer.jpg")))
ikomobi = Company.create!(name: "ikomobi", email: "contact@ikomobi.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "Parc Europe", city: "Marcq-en-Baroeul", postcode: "59700", description: "Agence mobile internationale. Développement d'applications natives et de sites mobiles.", coffee: true, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/ikomobi.jpg")))
mutualab = Company.create!(name: "Mutualab", email: "contact@mutualab.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "19 rue Nicolas Leblanc", city: "Lille", postcode: "59000", description: "Plus garnd espace de coworking de Lille. Nous disposons de 30 places en open space, 4 bureaux fermés et 1 salle de conférence.", coffee: true, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/mutualab.jpg")))
coroutine = Company.create!(name: "La Coroutine", email: "contact@lacoroutine.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "8 rue Molière", city: "Lille", postcode: "59000", description: "Espace de coworking posé. Si t'as besoin d'aide en RoR, Cécile n'est pas loin. Rejoins-nous !", coffee: true, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/coroutine.jpg")))
doumit = Company.create!(name: "Doumit", email: "contact@doumit.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "18 rue Basse", city: "Lille", postcode: "59000", description: "Agence web spacialisée en RoR. T'es dans une cave mal éclairée mais il y a moyen de se marrer !", coffee: true, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/doumit.jpg")))
ecotaco = Company.create!(name: "EcoTaco", email: "contact@ecotaco.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "Euratechnologies,165 avenue de Bretagne", city: "Lille", postcode: "59000", description: "Service web orienté mobilité. Je te recrute mais ne te rappelle jamais.", coffee: false, wifi: true, printer: false, scanner: false, picture: File.open(Rails.root.join("db/seeds/images/ecotaco.jpg")))
cofactory = Company.create!(name: "Co-Factory", email: "contact@cofactory.com", password: "12345678", password_confirmation: "12345678", siret:"40483304800022", address: "677 Avenue de la République", city: "Lille", postcode: "59000", description: "Encore un coworking-space. Ma particularité ? C'est que je n'ai rien de particulier.", coffee: true, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/cofactory.jpg")))
