...
ztp = julien.create_company!(name: "ZTP", siret:"40483304800022", address: "34 rue d'Athènes", city: "Lille", postcode: "59000", description: "A deux pas de la gare Lille Europe, meilleur incubateur du Nord !", coffee: true, wifi: true, printer: true, scanner: true, picture: File.open(Rails.root.join("db/seeds/images/cofactory.jpg")), open_monday: true, open_tuesday: true, open_wednesday: true, open_thursday: true, open_friday: true, open_saturday: false, open_sunday: false, start_time_am: "9:00 AM", end_time_am: "12:00 AM", start_time_pm: "2:00 PM", end_time_pm: "6:00 PM", phone_number: "0606060606")
...
# COFACTORY DESKS
cofactory_open_space = ztp.desks.create!(kind: "open_space", quantity: 15, description: "Open space avec bureaux, chaises, écrans, standing-desks et de la bonne musique.", half_day_price: 16, daily_price: 30, weekly_price: 100, activated: true)
cofactory_meeting_room = ztp.desks.create!(kind: "meeting_room", quantity: 1, description: "Salle 12 places avec un champignon téléphonique pour les conf calls et écran/enceintes/micros pour visio-conférences.", half_day_price: 50, daily_price: 90, weekly_price: 300, activated: true)
